...
For loop takes lipid 1 -> recenters lipid 1 -> extracts pdb of just lipid 1 -> saves the pdb of the whole system after being recentered so that we can subtract the COM of the bilayer to reach a common center for all lipids later.
