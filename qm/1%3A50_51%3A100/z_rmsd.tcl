...
set ravg1 [expr {$ravg1/138}]
set ravg2 [expr {$ravg2/138}]

puts -nonewline $outfile1 " $diff $ravg1 $ravg2 $highest_value1 $highest_value2 $highest_value1z $highest_value2z "
